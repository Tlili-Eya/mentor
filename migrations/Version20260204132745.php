 ...
 */
final class Version20260204132745 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE feedback (id INT AUTO_INCREMENT NOT NULL, contenu LONGTEXT NOT NULL, note INT NOT NULL, datefeedback DATE NOT NULL, typefeedback VARCHAR(255) NOT NULL, etatfeedback VARCHAR(255) NOT NULL, traitement_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_D2294458DDA344B6 (traitement_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('CREATE TABLE objectif (id INT AUTO_INCREMENT NOT NULL, description VARCHAR(50) NOT NULL, datedebut DATE NOT NULL, datefin DATE NOT NULL, statut VARCHAR(255) NOT NULL, programme_id INT NOT NULL, UNIQUE INDEX UNIQ_E2F8685162BB7AEE (programme_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
        ...
        $this->addSql('CREATE TABLE sortie_ai (id INT AUTO_INCREMENT NOT NULL, cible VARCHAR(20) NOT NULL, type_sortie VARCHAR(20) NOT NULL, criticite VARCHAR(20) NOT NULL, categorie_sortie VARCHAR(20) NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
