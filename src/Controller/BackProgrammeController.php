...
#[Route('/admin/programme', name: 'back_programme_')]
class BackProgrammeController extends AbstractController
{
...
if ($score === 0) {
    ...
    $meilleureMedaille = Medaille::Bronze;  // ← Au lieu de 'bronze'
} elseif ($score >= 50 && $score < 80) {
    $meilleureMedaille = Medaille::Argent;  // ← Au lieu de 'argent'
} else {
    $meilleureMedaille = Medaille::Or;      // ← Au lieu de 'or'
}
