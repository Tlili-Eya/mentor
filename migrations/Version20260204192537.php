 ...
 */
final class Version20260204192537 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE sortie_ai (id INT AUTO_INCREMENT NOT NULL, cible VARCHAR(20) NOT NULL, type_sortie VARCHAR(20) NOT NULL, criticite VARCHAR(20) NOT NULL, categorie_sortie VARCHAR(20) NOT NULL, contenu LONGTEXT NOT NULL, created_at DATE NOT NULL, updated_at DATE DEFAULT NULL, article_id INT NOT NULL, INDEX IDX_7A1A2FE67294869C (article_id), PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci`');
